...
public class SnoopInstructionMethodAdapter extends MethodVisitor implements Opcodes {
    ...
    protected final GlobalStateForInstrumentation instrumentationState;
    protected boolean isInit;
    protected boolean isSuperInitCalled; // Used to keep track of calls to super()/this() in <init>()
    protected int newStack = 0; // Used to keep-track of NEW instructions in <init>()
    protected LinkedList<TryCatchBlock> tryCatchBlocks;
    protected Label methodBeginLabel = new Label();
    protected Label methodEndLabel = new Label();
    protected Integer lastLineNumber = 0;
     ...
     */
    protected static void addBipushInsn(MethodVisitor mv, int val) {
        Utils.addBipushInsn(mv, val);
    }

    protected static void addBipushStringInsn(MethodVisitor mv, String str) {
        mv.visitLdcInsn(str);
    }
    ...
    private void addInsn(MethodVisitor mv, String insn, int opcode) {
        if (insn == "LOG") {
            ...
            addBipushStringInsn(mv, className);
            mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, insn, "(IILjava/lang/String;)V", false);
        } else {
            addBipushInsn(mv, instrumentationState.incAndGetId());
            addBipushInsn(mv, lastLineNumber);
    ...
    protected void addInvokeLogMethod(MethodVisitor mv) {
        addBipushInsn(mv, instrumentationState.incAndGetId());
        addBipushInsn(mv, lastLineNumber);
        addBipushStringInsn(mv, className);
        mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, "LOG", "(IILjava/lang/String;)V", false);
    }
...
//        break;
//      case POP2:
//          System.out.println("POP2 not handled");
//        //addInsn(mv, "POP2", opcode);
//        break;
//      case DUP:
//          System.out.println("DUP not handled");
//        //addInsn(mv, "DUP", opcode);
//        break;
//      case DUP_X1:
//          System.out.println("DUP_X1 not handled");
//        //addInsn(mv, "DUP_X1", opcode);
//        break;
//      case DUP_X2:
//          System.out.println("DUP_X2 not handled");
//        //addInsn(mv, "DUP_X2", opcode);
//        break;
//      case DUP2:
//          System.out.println("DUP2 not handled");
//        //addInsn(mv, "DUP2", opcode);
//        break;
//      case DUP2_X1:
//          System.out.println("DUP2_X1 not handled");
//        //addInsn(mv, "DUP2_X1", opcode);
//        break;
//      case DUP2_X2:
//          System.out.println("DUP2_X2 not handled");
...
//        }
    ...
    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
        //System.out.println("Not handle visitMethodInsn");
